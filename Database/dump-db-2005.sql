...
-- Dump dei dati della tabella libreria.books: ~3 rows (circa)
INSERT INTO `books` (`id_book`, `title`, `author`, `public_year`, `description`, `price`, `quantity`, `category_id`) VALUES
	...
	(3, 'asdsd', 'sdsd', '2014-05-15', 'sdsd', 11, NULL, 1),
	(4, 'asdsd', 'sdsd', '2014-05-15', 'sdsd', 11, NULL, 1);
...
-- Dump dei dati della tabella libreria.users: ~1 rows (circa)
