...
INSERT INTO `books` (`id`, `title`, `author`, `public_year`, `description`, `price_flexiblecover`, `price_hardcover`, `e_book`, `code_ebook`, `quantity`, `isbn`, `short_desch`, `category_id`, `img`) VALUES
	...
	(6, 'sss1111', 'sss', 114, 'sss', 3, 2, 2, 'ss', 1, 'ss', 'ss', 1, _binary ''),
	(10, 'horrriiisssssss', 'sdsds', 1998, 'sdsdsdssss', 4, 6, 3, '111111', 5, '121212', 'sdsds', 4, _binary '');
...
-- Dump dei dati della tabella libreria.book_in_order: ~3 rows (circa)
...
-- Dump dei dati della tabella libreria.order_list: ~4 rows (circa)
INSERT INTO `order_list` (`id`, `id_user`, `price`, `orderStatus`, `start`, `end`) VALUES
	...
	(4, 7, 22, 'Da spedire', NULL, NULL),
	(5, 7, 22, 'Da spedire', NULL, NULL);
